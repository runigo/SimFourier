...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%  DÉCALAGE ET AMPLITUDE
  ...
  \begin{scope}[xshift=0.2 cm,yshift=7.1cm, scale=0.7] % Décalage verticale
    \begin{scope}[xshift=3.2 cm]  %      Grille
      \fill[boutonEteint] (-0.075,0) rectangle (1.075,3.5);
      %\foreach \i in {1.15,2.3,...,3} {\draw[boutonEteint] (-0.075,\i)--(1.075,\i);}
     % \draw[boutonEteint] (-0.075,0)--(-0.075,3.5);
      \draw[boutonEteint] (1.075,0)--(1.075,3.5);
      \begin{scope}[xshift=0.4 cm,yshift=2.4 cm] % Nulle
          \draw[styleEteint] (0.1,0.5) node [gray]{\Large{\bf{0}}};
      \end{scope}
      \begin{scope}[xshift=0.4 cm,yshift=1.2 cm] % Unité
