...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%  DÉCALAGE
  ...
  \begin{scope}[xshift=2.23 cm,yshift=8.5cm, scale=0.7] % Centrage horizontal
      \fill[boutonEteint] (-0.075,1.15) rectangle (1.075,2.3);
      \draw[black] (0.3,1.9)--(0.1,1.7)--(0.3,1.5);
      \draw[black] (0.7,1.9)--(0.9,1.7)--(0.7,1.5);
  \end{scope}

  \begin{scope}[xshift=2.23 cm,yshift=7.2cm, scale=0.7] % minimum = 0
      \fill[boutonEteint] (-0.075,1.15) rectangle (1.075,2.3);
      \draw[black] (0.3,1.9)--(0.5,2.1)--(0.7,1.9);
  \end{scope}

  \begin{scope}[xshift=2.23 cm,yshift=6.2cm, scale=0.7] % Centrage verticale
      \fill[boutonEteint] (-0.075,1.15) rectangle (1.075,2.3);
      \draw[black] (0.3,1.9)--(0.5,2.1)--(0.7,1.9);
